...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : PEPin PEPin PEPin PEPin
                           ...
                           PEPin PEPin PEPin PEPin
                           PEPin PEPin PEPin */
  GPIO_InitStruct.Pin = A20_Pin|A19_Pin|FMC_NBL1_Pin|FMC_NBL0_CY7C1071DV33__Pin
                          |A21_Pin|A22_Pin|D5_Pin|D6_Pin
  ...
  /*Configure GPIO pins : PDPin PDPin PDPin PDPin
                           ...
                           PDPin PDPin PDPin PDPin
                           PDPin PDPin */
  GPIO_InitStruct.Pin = FMC_NE1_Pin|FMC_NWAIT_Pin|D2_Pin|FMC_NOE_Pin
                          |D3_Pin|FMC_NOED4_Pin|D1_Pin|D15_Pin
  ...
  /*Configure GPIO pins : PG12 PG10 PG6 */
  ...
  /*Configure GPIO pins : PI12 PI13 PI15 PI14 */
  ...
  GPIO_InitStruct.Pin = Potentiometer_Pin|GPIO_PIN_6;
  GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);
